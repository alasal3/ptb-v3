                    ...
                    <div className="container mx-auto px-4">
                        ...
                        <div className="mt-20">
                            ...
                            <div className=" flex flex-col md:flex-row justify-center gap-8 ">
                                {/* Phone */}
                                <a href="tel:01000262701" className="rounded-2xl glass-card p-8 hover:bg-slate-800/50 transition-colors group flex-1">
                                ...
                                {/* WhatsApp */}
                                <a href="https://wa.me/201000262701" target="_blank" rel="noopener noreferrer" className=" rounded-2xl glass-card p-8 hover:bg-slate-800/50 transition-colors group flex-1">
                                ...
                                {/* Email */}
                                <a href="mailto:info@prime-top-build.com" className=" rounded-2xl glass-card p-8 hover:bg-slate-800/50 transition-colors group flex-1">
                                    ...
                                    <p className="text-slate-300">info@prime-top-build.com</p>
                                </a>
                            </div>
                        </div>
                    </div>
