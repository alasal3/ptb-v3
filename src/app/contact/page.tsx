...
export const metadata: Metadata = {
    title: 'تواصل معنا - Prime Top Build',
    description: 'تواصل معنا لمعرفة المزيد عن مشاريعنا وأنظمة السداد.',
};
            ...
            <main className="relative z-10 pt-32 pb-20">
                <div className="container mx-auto px-4">
                    ...
                    <div className="mt-16 text-center">
                        <h2 className="text-3xl font-bold text-white mb-8">تواصل معنا مباشرة</h2>
                        ...
                        <div className="flex flex-col md:flex-row justify-center gap-8">
                            {/* Phone */}
                            <a href="tel:01000262701" className="glass-card p-6 min-w-[250px] hover:bg-slate-800/50 transition-colors group">
                                ...
                                <h3 className="text-lg font-bold text-white mb-1">اتصل بنا</h3>
                                <p className="text-slate-300" dir="ltr">01000262701</p>
                            </a>

                            {/* WhatsApp */}
                            <a href="https://wa.me/201000262701" target="_blank" rel="noopener noreferrer" className="glass-card p-6 min-w-[250px] hover:bg-slate-800/50 transition-colors group">
