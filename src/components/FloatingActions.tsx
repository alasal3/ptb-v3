...
export default function FloatingActions() {
    ...
    return (
        <div className="fixed bottom-6 left-6 z-50 flex flex-col items-center gap-4">
            {/* Options (Reveal when open) */}
            <div className={`flex flex-col gap-3 transition-all duration-300 ${isOpen ? "opacity-100 translate-y-0 scale-100" : "opacity-0 translate-y-10 scale-0 pointer-events-none"}`}>
            ...
            <button
                ...
                className={`w-14 h-14 rounded-full flex items-center justify-center shadow-lg transition-all duration-300 z-50 ${isOpen ? "bg-red-500 rotate-90" : "bg-blue-600 hover:bg-blue-700 animate-bounce-slow"}`}
